...
*/
func (a *GenresApiService) GetAllGenres(ctx context.Context) (InlineResponse20022, *http.Response, error) {
	var (
...
*/
func (a *GenresApiService) GetGenreBase(ctx context.Context, id float64) (InlineResponse20023, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
